...
f1 = plt.figure(1)
plt.subplot(3,1,1)
plt.plot(sim_time,mrp_truth_0,sim_time,nav['mrp_minus_0'],sim_time,nav['mrp_plus_0'])
plt.subplot(3,1,2)
plt.plot(sim_time,mrp_truth_1,sim_time,nav['mrp_minus_1'],sim_time,nav['mrp_plus_1'])
plt.subplot(3,1,3)
plt.plot(sim_time,mrp_truth_2,sim_time,nav['mrp_minus_2'],sim_time,nav['mrp_plus_2'])
plt.plot()
