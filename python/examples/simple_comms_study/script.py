...
attx_comm.params.antenna_diameter(0.5)                                  # Recieve antenna diameter in meters
attx_comm.params.antenna_efficiency(60)                                 # Recieve antenna efficiency as a percentage (0 to 100)
attx_comm.params.noise_temperature(250)                                 # Noise temperature in Kelvin
attx_comm.params.loss_RX(4.0)                                           # Recieve system losses in dB
...
rolla_comm.params.antenna_diameter(0.5)                                  # Recieve antenna diameter in meters
rolla_comm.params.antenna_efficiency(60)                                 # Recieve antenna efficiency as a percentage (0 to 100)
