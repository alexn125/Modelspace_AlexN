...
rolla_comm.params.frequency(0.437e9)                                      # Frequency in Hz
rolla_comm.params.bit_rate(0.0096e6)                                          # Bit rate in bits per second
rolla_comm.params.power_TX(14.0)                                           # Transmit power in decibel-milliwatts (dBm)
rolla_comm.params.gain_TX(16.0)                                           # Transmit antenna gain in (dBi)
rolla_comm.params.loss_TX(3.0)                                           # Transmit system losses in dB
rolla_comm.params.gain_RX(2.15)                                           # Receive antenna gain in (dBi)
...
rolla_comm.params.energy_per_bit_to_noise_ratio_required(4.0)              # Required energy per bit to noise ratio in dB for link budget closure
