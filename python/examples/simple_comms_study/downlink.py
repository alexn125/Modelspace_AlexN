...
rolla_comm.params.power_TX(-3.0)                                           # Transmit power in decibel-milliwatts (dBm)
rolla_comm.params.gain_TX(2.15)                                           # Transmit antenna gain in (dBi)
rolla_comm.params.loss_TX(2.0)                                           # Transmit system losses in dB
rolla_comm.params.gain_RX(13.9)                                           # Receive antenna gain in (dBi)
